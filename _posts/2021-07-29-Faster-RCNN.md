...
<img src="https://imgdetail.ebookreading.net/20201209/5/9781617296192/9781617296192__deep-learning-for__9781617296192__OEBPS__Images__7-12.png" style="display:block; margin-left:auto; margin-right:auto">
...
- Trong Faster R-CNN chúng ta xác định được vị trí của anchor boxes trên features (dựa vào vị trí của sliding window), sau đó chúng ta xác định ngược lại vùng tương ứng của anchor boxes trên original image.
...
Nếu anchor overlap lớn với ground-truth box thì coi nó chứa object và được gán nhãn **positive**. Anchor có overlap nhỏ với ground-truth thì coi không chứa object và được gán nhãn **negative**. Những anchor có IoU trong khoảng $(0.3, 0.7)$ không được sử dụng trong quá trình training.
