...
- True Positive: dự đoán là có thai - Positive, thực tế thì đúng là có thai (True)
- False Positive: dự đoán là có thai - Positive, thực tế thì không có thai (False). Dự đoán người không có thai thành có thai.
...
- FN (False Negative): droudth-truth box không được phát hiện (mô hình không bắt được đối tượng trong ảnh )
...
> Predicted boxes phải được phân loại đúng class trước và sau đó chúng ta mới đi xác định precision và recall dựa trên IoU. Chứ bây giờ phân loại sai class mà xác định IoU thì không có ý nghĩa.
